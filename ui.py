...
def main():
  ...
  num_tiles_width = int((SCREEN_WIDTH - BORDER_BUFFER * RADIUS) / HexMap.HexMap.calc_tile_spacing_horiz(RADIUS))
  num_tiles_height = int((SCREEN_HEIGHT - BORDER_BUFFER * RADIUS) / HexMap.HexMap.calc_tile_spacing_vert(RADIUS))
